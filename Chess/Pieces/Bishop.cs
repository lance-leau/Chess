...
{
    public Bishop(Color color, Board board, Cell cell) : base(color, Type.Bishop, board, cell)
    {
    }
    
    public override char symbole()
    {
        return this._Color == Color.White ? 'B' : 'b';
    }
    
    public override float value()
    {
        return this._Color == Color.White ? 3 : -3;
    }
    ...
    public override List<Cell> getMoves()
    {
        ...
        // moves up left -----------------------------------------------------------------------------------------------
        (int row, int col) = (currentRow-1, currentCol-1);
